...
{
    internal class AsyncResultPagedListEnumerator<T> : IAsyncEnumerator<T>
    {
        ...
        public IPagedList<T> CurrentList { get; private set; }
        ...
        public AsyncResultPagedListEnumerator(
        ...
        public async ValueTask<bool> MoveNextAsync()
        {
            ...
            {
                // (re)fetch
                CurrentList = await PagedListProducer((Count, NextSkip, CurrentList?.ContinuationToken, CancellationToken)).ConfigureAwait(false);
                CurrentListIndex = -1;
